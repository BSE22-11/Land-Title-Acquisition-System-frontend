  ...
  return (
    <Page title="Dashboard">
      <Container maxWidth="xl">
        ...
        <br/>
        <br/>
        <Link to="/files/land-form19-freehold-offer.pdf" target="_blank" download>Demarcation form 20</Link>
        <br/>
        <br/>
        <Link to="/files/land-form19-freehold-offer.pdf" target="_blank" download>Inspection report</Link>
        <br/>
        <br/>

        
        <Link to="/lreg/reject"><Button variant="contained" >Reject</Button></Link><br/><br/>
        <Link to="/lreg/upload"><Button variant="contained" >Upload documents</Button></Link>
